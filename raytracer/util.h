...
struct Material {
	Material( Colour ambient, Colour diffuse, Colour specular, double exp,double reflectionCoef, double refractionCoef ) :
		ambient(ambient), diffuse(diffuse), specular(specular), 
		specular_exp(exp),reflection_coef(reflectionCoef),refraction_coef(refractionCoef) {}
...
struct Intersection {
	...
	// This is used when you need to intersect multiple objects and
